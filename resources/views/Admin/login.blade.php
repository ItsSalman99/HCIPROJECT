                        ...
                        <form action="{{ route('admin.loginpost') }}" id="roamersignup" method="post">
                            ...
                            <div class="form-group">
                                <div class=" position-relative">
                                    ...
                                    <i class="toggle-password bi bi-eye position-absolute top-50 translate-middle-y font-20px opacity-06"
                                        style="right: 10px; cursor:pointer " toggle="#password-field"></i>
                                </div>
                            </div>
                            <div class="text-end">
                                <ul>
                                    <li><a href="javascript:void(0)"
                                            class=" black-anchor opacity-07 font-weight-400 hover-opacity-09">Recovery
                                            Password</a></li>
                                </ul>
                            </div>
                            <br>
                            ...
                            <div class="text-center">
                                <button type="submit" name="submit"
                                    class="btn btn-primary d-block w-100 text-uppercase font-weight-600 py-3">Sign
                                    In</button>
                            </div>
                            <br>
                            <br>
                            <ul class=" text-center">
                                <li><span class=" opacity-07 font-weight-400">If you don’t have an account, </span><a
                                        href="{{ route('admin.signup') }}" class=" primary-anchor text-uppercase">BECOME
                                        a Seller</a></li>
                            </ul>
                        </form>
                    </div>
