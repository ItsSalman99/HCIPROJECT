                    ...
                    ">
                        <div class="text-center">
                            ...
                            <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea <br>
                                commodo consequat.</p>
                            <br>
                            <form action="{{ route('roamer.send-mail') }}" method="POST" class="input-height-49px">
                                @csrf
                                <div class="row gx-2">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <textarea rows="5" name="msg" class=" form-control" placeholder="Your Message"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <br>
                                        <br>
                                        <button type="submit" class=" btn btn-primary extra-btn-padding-50">Contact Us</button>
                                    </div>
                                </div>
                            </form>
                        </div>
