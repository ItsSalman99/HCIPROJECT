...
@section('content')
    <div class="cover-all-content">
        ...
        <div class="cover-inner-content">
            <div class="row g-3">
                <div class="col-lg-8">
                    <form action="{{ route('brands.store') }}" method="POST" id="brandForm" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card border-0">
                            ...
                            <ul class="d-flex align-items-center justify-content-center flex-wrap gap-3">
                                ...
                                <li><button class="btn btn-primary extra-btn-padding-80 text-uppercase">Save Brand</button>
                                </li>
                            </ul>
                        </div>
                    </form>
