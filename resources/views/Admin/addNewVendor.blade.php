...
@section('content')
                ...
                <div class="row g-3">
                    <div class="col-lg-8">
                            ...
                            <div class="card-body Horizontal-label white-bg-clr-02">
                                <div class="row gy-4">
                                    ...
                                    @if (Auth::user()->user_type == 1)
                                        <div class="col-lg-6">
                                            <div class="row align-items-center gx-4">
                                                <label for="" class="col-4">Roamer</label>
                                                <div class="col-8">
                                    ...
                                    @elseif(Auth::user()->user_type == 2)
                                        <input type="text" hidden name="roamer_id" value="{{ Auth::user()->id }}" hidden>
                                    @endif
                                    <div class="col-lg-6">
                                        <div class="row align-items-center gx-4">
                                            ...
                                            <div class="col-8">
                                                <input type="text" name="nearby_market" class="form-control"
                                                    placeholder="Nearby Market Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row align-items-center gx-4">
                                            ...
                                            <div class="col-8">
                                                <input type="number" name="contact3" class="form-control"
                                                    placeholder="#+92">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="row align-items-center gx-4">
                                            ...
                                            <div class="col-8">
                                                <input type="number" name="contact4" class="form-control"
                                                    placeholder="#+92">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="row align-items-center gx-4">
                                            ...
                                            <div class="col-8">
                                                <label class="cswitch">
                                                    <input class="cswitch--input" name="holiday_mode" value="0"
                        ...
                        <ul class="d-flex align-items-center justify-content-center flex-wrap gap-3">
                            ...
                            <li><button type="submit" id="vendorSaveBtn"
                                    class="btn btn-primary extra-btn-padding-80 text-uppercase">Submit</button>
                        </ul>
                    </div>
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body lgray-bg-1 tipcard">
                                <h6>Tips</h6>
                                <p class=" mb-4">1. Please add correct details of vendors without ambiguities. Addition of
                                    wrong data may lead to deactivation of your account and loss of job.</p>
                                <p class="mb-4">2. Addition of vendor(s) is important because every product you add has
                                    to
                                    be associated with its actual vendor.</p>
                                <p class="mb-4">3. Try to add more and more vendors. More vendors mean more products
                                    which inturn means more orders. Fulfilling more orders will get you your bonus with your
                                    pay."</p>
                            </div>
                        </div>
                    </div>
    ...
    @push('extra-js')
        <script>
            $('#vendorAddForm').on('submit', function(e) {

                e.preventDefault();

                var formData = new FormData(this);

                $('#vendorSaveBtn').html('Submitting');
                $('#vendorSaveBtn').attr('disabled', true);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == false) {
                            ...
                            $('#addsuccesstoaster').addClass('show')
                            $('#title').html("Vender Added Successfully!!")
