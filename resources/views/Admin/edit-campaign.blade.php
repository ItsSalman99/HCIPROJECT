...
@section('content')
    <div class="cover-all-content">
        ...
        <div class="cover-inner-content">
            <div class="row g-3">
                <div class="col-lg-8">
                    <form action="{{ route('admin.compaign.update', ['id' => $campaign->id]) }}" method="POST"
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="row align-items-center g-0">
                                        ...
                                        <div class="col-lg-10 ">
                                            <input name="compaign_name" type="text" class=" form-control"
                                                placeholder="Ex. Electronics Essentials 25th To 28th March"
                                                value="{{ $campaign->compaign_name }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-group m-0 StartEndDate-v1">
                                                <input name="compaign_start" type="text" class="reviewStartDate"
                                                    placeholder="Start Date" value="{{ $campaign->compaign_start }}"
                                                    style="width: 50%;" required />
                                                <input name="compaign_end" type="text" class="reviewEndDate"
                                                    placeholder="- End Date" value="{{ $campaign->compaign_end }}"
                                                    style="width: 50%;" required />
                                        ...
                                        <div class="col-lg-7">
                                            <div class="form-group m-0 StartEndDate-v1">
                                                <input name="registeration_start" type="text" class="reviewStartDate"
                                                    placeholder="Start Date" value="{{ $campaign->registeration_start }}"
                                                    style="width: 50%;" required />
                                                <input name="registeration_end" type="text" class="reviewStartDate"
                                                    value="{{ $campaign->registeration_end }}" placeholder="- End Date"
                                                    style="width: 50%;" required />
                                                <i class="bi bi-calendar4"></i>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-10">
                                                    <select class="js-example-basic-single w-100" name="category_id[]"
                                                        ...
                                                        @foreach ($category as $item)
                                                            <option value="{{ $item->id }}" <?php if (checkCampaignCategory($campaign->id, $item->id)) {
                                                                echo 'selected';
                                                            } ?>>
                                                                {{ $item->name }}
                                                            </option>
                                ...
                                <div class="form-group" id="check">
                                    @if ($campaign->off_percent != null)
                                        <div class="row align-items-center">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <div class="row align-items-center">
                                                        <div class="col-lg-4"><label for=""
                                                                class="mb-lg-0">Percentage Off</label></div>
                                                        <div class="col-lg-8"><input name="off_percent" type="text"
                                                                class=" form-control" placeholder="%"
                                                                value="{{ $campaign->off_percent }}"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    @elseif($campaign->fix_amount != null)
                                        <div class="row align-items-center">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <div class="d-flex gap-4 align-items-center">
                                                        <div class=" text-start text-lg-end"><label for=""
                                                                class="mb-lg-0">Fix Off</label></div>
                                                        <div class="w-50">
                                                            <input name="fix_amount" type="number" class=" form-control"
                                                                placeholder="Amount" value="{{ $campaign->fix_amount }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="upload-image-box-v1">
                                                <label for="brandLogo1" class="brandLogo bg-white" style="width: 168px;">
                                                    <img alt=""
                                                        src="{{ asset('storage/compaign/' . $campaign->banner_img1) }}"
                                                        id="brandLogoImg1" class="uploadimage">
                                            ...
                                            <div class="upload-image-box-v1">
                                                <label for="brandLogo2" class="brandLogo bg-white" style="width: 168px;">
                                                    <img alt=""
                                                        src="{{ asset('storage/compaign/' . $campaign->banner_img2) }}"
                                                        id="brandLogoImg2" class="uploadimage">
