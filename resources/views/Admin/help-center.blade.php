...
@section('content')
    <div class="cover-all-content">
        ...
        <div class="cover-inner-content">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class=" position-relative">
                        ...
                        <i class="material-icons position-absolute top-50 translate-middle-y opacity-04"
                            style="right: 10px;">
                            search
                        </i>
                    </div>
            ...
            <br>
            <br>
            <h5 class=" font-18px font-weight-600 mb-3">Some New <span class=" primary-text">Tips</span></h5>
            <div class="row g-2">
                <div class="col-lg-12">
                    <div class="row g-2">
                        <div class="col-lg-12">
                ...
                <div class="d-flex align-items-center justify-content-between gap-4 gap-lg-0 flex-wrap">
                    <div class="padding-inline-5vw flex-1 ">
                        <div class=" d-flex align-items-center gap-3 position-relative">
                            <div class="svg-icon bg-white border-radius-50px d-flex align-items-center justify-content-center"
                                style="width:46px; aspect-ratio: 1/1;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="27" viewBox="0 0 25 27"
                                    class="primary-svg ">
                                    <path
                                        d="M8.48326 5.02539H3.92072C3.49847 5.02539 3.15625 5.36761 3.15625 5.78986C3.15625 6.21211 3.49847 6.55433 3.92072 6.55433H8.48326C8.90531 6.55433 9.24773 6.21211 9.24773 5.78986C9.24773 5.36761 8.90531 5.02539 8.48326 5.02539Z" />
                                    <path
                                        d="M8.48326 8.08203H3.92072C3.49847 8.08203 3.15625 8.42425 3.15625 8.8465C3.15625 9.26875 3.49847 9.61097 3.92072 9.61097H8.48326C8.90531 9.61097 9.24773 9.26875 9.24773 8.8465C9.24773 8.42425 8.90531 8.08203 8.48326 8.08203Z" />
                                    <path
                                        d="M8.48326 11.1484H3.92072C3.49847 11.1484 3.15625 11.4907 3.15625 11.9129C3.15625 12.3352 3.49847 12.6774 3.92072 12.6774H8.48326C8.90531 12.6774 9.24773 12.3352 9.24773 11.9129C9.24773 11.4907 8.90531 11.1484 8.48326 11.1484Z" />
                                    <path
                                        d="M8.48326 14.1973H3.92072C3.49847 14.1973 3.15625 14.5395 3.15625 14.9617C3.15625 15.384 3.49847 15.7262 3.92072 15.7262H8.48326C8.90531 15.7262 9.24773 15.384 9.24773 14.9617C9.24773 14.5395 8.90531 14.1973 8.48326 14.1973Z" />
                                    <path
                                        d="M8.48326 17.3086H3.92072C3.49847 17.3086 3.15625 17.651 3.15625 18.0731C3.15625 18.4953 3.49847 18.8375 3.92072 18.8375H8.48326C8.90531 18.8375 9.24773 18.4953 9.24773 18.0731C9.24773 17.651 8.90531 17.3086 8.48326 17.3086Z" />
                                    <path
                                        d="M11.0496 6.55433H15.6122C16.0344 6.55433 16.3766 6.21211 16.3766 5.78986C16.3766 5.36761 16.0344 5.02539 15.6122 5.02539H11.0496C10.6276 5.02539 10.2852 5.36761 10.2852 5.78986C10.2852 6.21211 10.6276 6.55433 11.0496 6.55433Z" />
                                    <path
                                        d="M11.0496 9.61097H15.6122C16.0344 9.61097 16.3766 9.26875 16.3766 8.8465C16.3766 8.42425 16.0344 8.08203 15.6122 8.08203H11.0496C10.6276 8.08203 10.2852 8.42425 10.2852 8.8465C10.2852 9.26875 10.6276 9.61097 11.0496 9.61097Z" />
                                    <path
                                        d="M14.0116 11.9129C14.0116 11.4907 13.6693 11.1484 13.2471 11.1484H11.0496C10.6276 11.1484 10.2852 11.4907 10.2852 11.9129C10.2852 12.3352 10.6276 12.6774 11.0496 12.6774H13.2471C13.6693 12.6774 14.0116 12.3352 14.0116 11.9129Z" />
                                    <path
                                        d="M21.249 17.6291C20.9197 17.365 20.4388 17.4177 20.1744 17.747L18.2055 20.2017L16.9865 19.3185C16.6447 19.0707 16.1665 19.1471 15.9188 19.489C15.6712 19.831 15.7476 20.309 16.0894 20.5566L17.8977 21.8668C18.0331 21.9647 18.1899 22.0123 18.3458 22.0123C18.5702 22.0123 18.792 21.9138 18.9425 21.726L21.3671 18.7038C21.6313 18.3745 21.5785 17.8933 21.249 17.6291Z" />
                                    <path
                                        d="M23.178 15.2864C22.1822 14.2731 20.9027 13.6345 19.5163 13.4463V3.07879C19.5163 1.38122 18.1351 0 16.4375 0H3.07899C1.38122 0 0 1.38122 0 3.07879V20.7876C0 22.4854 1.38122 23.8666 3.07879 23.8666H13.823C15.032 25.2869 16.7704 26.0939 18.6511 26.0939C22.1519 26.0939 25 23.2439 25 19.7407C25 18.0636 24.353 16.4817 23.178 15.2864ZM1.52894 20.7876V3.07879C1.52894 2.22433 2.22433 1.52894 3.07899 1.52894H16.4375C17.2922 1.52894 17.9874 2.22433 17.9874 3.07879V13.422C14.7973 13.7551 12.3022 16.4616 12.3022 19.7407C12.3022 20.6495 12.4917 21.5282 12.8553 22.3375H3.07899C2.22433 22.3375 1.52894 21.6423 1.52894 20.7876ZM18.6511 24.565C17.1244 24.565 15.7208 23.864 14.8001 22.6421C14.1662 21.8006 13.831 20.7974 13.831 19.7407C13.831 17.0806 15.9934 14.9163 18.6511 14.9163C18.6762 14.9163 18.7015 14.9167 18.7266 14.9171L18.7383 14.9173C20.007 14.9398 21.1966 15.4515 22.0876 16.3581C22.9797 17.2657 23.4711 18.4672 23.4711 19.7407C23.4711 22.4008 21.3088 24.565 18.6511 24.565Z" />
                                </svg>
                            </div>
                            <div>
                                <a href="#"
                                    class=" font-weight-600 text-white hover-opacity-08 d-block">Terms And Conditions

                                </a>

                                {{-- <ul class=" position-absolute edit-pencil" style="right: 146px; top: -9px; z-index:10">
                                    <li><a href="#" data-bs-toggle="modal"
                                            data-bs-target="#EditTermsAndConditionModal">
                            ...
                            <ul>
                                <li><a href="#"
                                        ...
                                        style="right: 10px"><i class="material-icons primary-text"
                                            style="font-size: 27px; width:25px; height:25px">
                                            chevron_right
                                        </i></a></li>
                            </ul>
                        </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="AddFaqModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
            aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="card-body pt-4">
                        <div class="modal-header">
                            <h5 class="card-title font-18px">Add <span class=" primary-text">New Faq</span></h5>
                        ...
                        <div class="modal-body py-4">
                            <form action="{{ route('help-center.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="" class="mb-3">Title FAQ</label>
                                    <div class=" position-relative">
                                        <input type="text" name="title" placeholder="Define Title"
                                ...
                                <br>
                                <div class="form-group">
                                    <label for="" class="mb-3">FAQ Content</label>
                                    <textarea class="editor" name="content" placeholder="Type here..."></textarea>
                                </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="EditFaqModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
            aria-hidden="true">
            <div class="modal-dialog modal-md modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="card-body pt-4">
                        <div class="modal-header">
                            <h5 class="card-title font-18px">Edit <span class=" primary-text">Faq</span></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body py-4">
                            <form action="">
                                <div class="form-group">
                                    <label for="" class="mb-3">Title FAQ</label>
                                    <div class=" position-relative">
                                        <input type="text" placeholder="Define Title" class=" form-control"
        ...
        <!-- Modal -->
        <div class="modal fade" id="EditTermsAndConditionModal" tabindex="-1" role="dialog"
            aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="card-body pt-4">
                        <div class="modal-header">
                            <h5 class="card-title font-18px">Edit <span class=" primary-text">Terms And Condition</span>
                            </h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body py-4">
                            <form action="">
                                <div class="form-group">
                                    <label for="" class="mb-3">Terms And Condition Content</label>
                                    <textarea class="editor" placeholder="Type here..."></textarea>
                                </div>
                                <div class="text-center mt-5">
                                    <button class="btn btn-primary extra-btn-padding-45 text-uppercase">Update</button>
        ...
        <!-- Modal -->
        <div class="modal fade" id="EditprivacypolicyModal" tabindex="-1" role="dialog"
            aria-labelledby="modelTitleId" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="card-body pt-4">
                        <div class="modal-header">
                            <h5 class="card-title font-18px">Edit <span class=" primary-text">Privacy Policy</span></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body py-4">
                            <form action="">
                                <div class="form-group">
                                    <label for="" class="mb-3">Privacy Policy Content</label>
                                    <textarea class="editor" placeholder="Type here..."></textarea>
                                </div>
                                <div class="text-center mt-5">
                                    <button class="btn btn-primary extra-btn-padding-45 text-uppercase">Update</button>
