    ...
    <div class="cover-inner-content">
        <div class="mediacenter d-flex align-items-center justify-content-center justify-content-md-start flex-wrap">
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/1.png" alt="" class="small-product-image">
                <div>
                    <ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/2.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/3.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/4.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/5.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/6.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/7.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/8.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/9.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
            ...
            <div class="mediacenter-box d-flex align-items-center gap-3">
                <img src="assets/admin/images/products/10.png" alt="" class="small-product-image">
                <div>
                    <ul>
                        <li><a href="javascript:void(0)" class="  black-anchor text-truncate" style="width: 80px;">HTB1iutWlM...</a></li>
                    </ul>
