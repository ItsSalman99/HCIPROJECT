...
<head>
    ...
    <link rel="stylesheet" href="vendor/css/intel/intlTelInput.min.css">
...
<body class="login-register-body">
            ...
            <div class="form-area">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <br>
                        <p class="text-center fst-italic">Individual will need Personal Identity card and at least 18 years old in order to sell as <br> Individual on BazaarOnline</p>
                        <br>
                        <br>
                        <form action="">
                            <div class="row g-2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class=" position-relative">
                                            ...
                                            <i class="toggle-password bi bi-eye position-absolute top-50 translate-middle-y font-20px opacity-06" style="right: 10px; cursor:pointer " toggle="#password-field1"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class=" position-relative">
                                            <input id="password-field2" type="password" name="cpassword" class="form-control" placeholder="Confirmed Password" required>
                                            <i class="toggle-password bi bi-eye position-absolute top-50 translate-middle-y font-20px opacity-06" style="right: 10px; cursor:pointer " toggle="#password-field2"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class=" form-control" placeholder="Enter Name of Smartphone Mobile Model You Have">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <br>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="tel" id="verifyphone" value="+1">
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="text-center">
                                <label for="policy" class="font-weight-500">
                                    ...
                                    I agree to the <a href="javascript:void(0)" class=" primary-anchor">Terms</a> and <a href="javascript:void(0)" class=" primary-anchor"> Privacy Policy</a>.
                                </label>
                            </div>
                            <br>
                            <br>
                            <div class="text-center">
                                <a class="btn btn-primary width-100 width-md-50 justify-content-center text-uppercase font-weight-600 py-3" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#requestAccountModal">Sign up</a>
                            </div>
                            <br>
                            <br>
                            <ul class=" text-center">
                                <li><span class=" opacity-07 font-weight-400">If you have an account, </span><a href="login.php" class=" primary-anchor text-uppercase">SIGN IN</a></li>
                            </ul>
                        </form>
                    </div>
                </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="requestAccountModal" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content border-radius-15px">
                ...
                <div class="card-body p-3 p-md-5 text-center">
                    ...
                    <p>We have received your request to become a roamer. Our Roamer Guide will contact you soon before approval.</p>
                    <br>
                    <br>
                    <!-- <button type="button" class=" btn btn-primary extra-btn-padding-40" data-bs-dismiss="modal">OK</button> -->
                    <a href="index.php" class="btn btn-primary extra-btn-padding-40">OK</a>
                </div>
    ...
    <script src="vendor/js/intel/intlTelInput.min.js"></script>
    <script src="vendor/js/intel/utils.js"></script>
