                    ...
                    <div class="card notification-box white-bg-clr-02">
                        <div class="card-body2">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <a href="javascript:void(0)" class="default-black font-weight-600 primary-hover-clr text-truncate d-block" s style="width: clamp(16rem, 20vw, 22rem)">Avoid Cancellations through our guide Avoid Cancellations through our guide</a>
                                    <p class="m-0 font-12px">This PK Day, avoid Cancellations through our guide!</p>
                                </div>
                            </div>
                        </div>
